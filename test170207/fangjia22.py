...
b=[]
ab=['盛华景苑','徐汇华园','南方新村','中海瀛台','徐汇苑','徐汇臻园','紫阳花园','印象欧洲','浦润苑','华唐苑','银泰苑','新凯家园一期','中冶锦城','漓江山水花园','华泾绿苑','华泾五村','华欣家园','东湾小区','馨宁公寓','徐汇新干线','爱庐世纪新苑','新弘国际城','南方城','晶欣坊','华发小区','枫桦景苑','华建一街坊','华沁家园','东湾度假村']
a=['南方新村','盛华景苑','徐汇华园','枫桦景苑']
...
if __name__ == '__main__':
    pool =Pool(8)
    for i in a:
        b.append( pool.apply_async(test,args=(i,)) )
