...
#     else:
#         print(i[0].split(' ')[0] + " 本月" + yellowprint(i[0].split(' ')[2].split('元')[0]) + "元/平方米 , 比上月 " + greenprint((i[0].split(' ')[5])))
for i in e:
    if '↑' in i.split(' ')[5]:
        print(i.split(' ')[0]+" 本月" + yellowprint(i.split(' ')[2].split('元')[0]) + "元/平方米 , 比上月 " +  redprint(i.split(' ')[5])   )
    else:
        print(i.split(' ')[0] + " 本月" + yellowprint(i.split(' ')[2].split('元')[0]) + "元/平方米 , 比上月 " + greenprint(
            i.split(' ')[5]))
